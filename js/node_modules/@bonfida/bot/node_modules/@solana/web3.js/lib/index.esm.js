...
import { coerce, instance, string, tuple, literal, unknown, union, type, optional, number, boolean, record, nullable, array, create, assert } from 'superstruct';
...
class Secp256k1Program {
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    invariant(privateKey.length === PRIVATE_KEY_BYTES, `Private key must be ${PRIVATE_KEY_BYTES} bytes but received ${privateKey.length} bytes`);
