...
const TokenAmountResult = superstruct.type({
  ...
  uiAmountString: superstruct.optional(superstruct.nullable(superstruct.string()))
});
/**
...
class Secp256k1Program {
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    invariant__default['default'](privateKey.length === PRIVATE_KEY_BYTES, `Private key must be ${PRIVATE_KEY_BYTES} bytes but received ${privateKey.length} bytes`);
